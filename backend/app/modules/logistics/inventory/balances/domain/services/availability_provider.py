...
class InventoryBalanceAvailabilityProvider:
    ...
    def get_summary_metrics(self, position_balances: list[dict[str, Any]]) -> dict[str, Decimal]:
        """Calcula el resumen completo de las 8 métricas de saldos para las posiciones especificadas."""
        return {
            ...
            "reserved_stock": self.formula_service.calculate_reserved_stock(position_balances),
            ...
            "damaged_stock": self.formula_service.calculate_damaged_stock(position_balances),
            "expired_stock": self.formula_service.calculate_expired_stock(position_balances),
        }
