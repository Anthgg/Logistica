"""Phase 045 — Reconcile Phase 028 Vehicle Verification Tables.

Revision ID: gj450510045vr
...
revision: str = 'gj450510045vr'
down_revision: Union[str, None] = 'gi450410045dk'
...
def upgrade() -> None:
    ...
    if 'vehicle_verification_sources' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verification_sources" ENABLE ROW LEVEL SECURITY;')

    # 2. vehicle_verification_provider_configurations
    if 'vehicle_verification_provider_configurations' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verification_provider_configurations" ENABLE ROW LEVEL SECURITY;')

    # 3. vehicle_verifications
    if 'vehicle_verifications' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verifications" ENABLE ROW LEVEL SECURITY;')

    # 4. vehicle_verification_results
    if 'vehicle_verification_results' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verification_results" ENABLE ROW LEVEL SECURITY;')

    # 5. vehicle_verification_field_provenance
    if 'vehicle_verification_field_provenance' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verification_field_provenance" ENABLE ROW LEVEL SECURITY;')

    # 6. vehicle_verification_evidence
    if 'vehicle_verification_evidence' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verification_evidence" ENABLE ROW LEVEL SECURITY;')

    # 7. assisted_vehicle_verifications
    if 'assisted_vehicle_verifications' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."assisted_vehicle_verifications" ENABLE ROW LEVEL SECURITY;')

    # 8. vehicle_verification_conflicts
    if 'vehicle_verification_conflicts' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verification_conflicts" ENABLE ROW LEVEL SECURITY;')

    # 9. vehicle_verification_requirements
    if 'vehicle_verification_requirements' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verification_requirements" ENABLE ROW LEVEL SECURITY;')

    # 10. vehicle_verification_review_tasks
    if 'vehicle_verification_review_tasks' not in existing_tables:
        op.create_table(
        ...
        if bind.dialect.name == 'postgresql':
            op.execute('ALTER TABLE public."vehicle_verification_review_tasks" ENABLE ROW LEVEL SECURITY;')


def downgrade() -> None:
    op.drop_table('vehicle_verification_review_tasks', if_exists=True)
    op.drop_table('vehicle_verification_requirements', if_exists=True)
    op.drop_table('vehicle_verification_conflicts', if_exists=True)
    op.drop_table('assisted_vehicle_verifications', if_exists=True)
    op.drop_table('vehicle_verification_evidence', if_exists=True)
    op.drop_table('vehicle_verification_field_provenance', if_exists=True)
    op.drop_table('vehicle_verification_results', if_exists=True)
    op.drop_table('vehicle_verifications', if_exists=True)
    op.drop_table('vehicle_verification_provider_configurations', if_exists=True)
    op.drop_table('vehicle_verification_sources', if_exists=True)
