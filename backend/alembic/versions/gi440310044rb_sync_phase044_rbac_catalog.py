"""Synchronize the Phase 044 inventory-ledger RBAC catalog.

Revision ID: gi440310044rb
Revises: gh440210044mg
Create Date: 2026-08-10 22:22:00.000000
"""
...
revision: str = "gi440310044rb"
down_revision: str | Sequence[str] | None = "gh440210044mg"
...
def upgrade() -> None:
    ...
    for permission in PHASE_044_PERMISSIONS:
