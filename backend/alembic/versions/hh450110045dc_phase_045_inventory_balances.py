...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("availability_state", sa.String(50), nullable=False, server_default="AVAILABLE", index=True),
        sa.Column("quality_state", sa.String(50), nullable=False, server_default="APPROVED", index=True),
        ...
        sa.Column("expiration_state", sa.String(50), nullable=False, server_default="FRESH", index=True),
